<div class="transparent-900 m-10 mx-auto w-4/5 rounded-xl">
	<div class="flex gap-5">
		<div class="ml-10 flex w-3/5 flex-col justify-start gap-5 pt-10">
			<!-- cpu info -->
			...
			<div class="transparent-800 rounded-xl p-10 text-left">
				...
				<div>
					<TemperatureChart statistics={$hardwareStatistics.cpu.temperature} />
				</div>
			</div>
		</div>

		<div class="mr-10 flex w-2/5 flex-col justify-start gap-5 pt-10">
			<!-- cpu power usage -->
			<div class="transparent-800 rounded-xl p-10 text-left">
				<div class="mb-5 flex items-baseline gap-3">
				...
				<div>
					<LineChart statistics={$hardwareStatistics.cpu.power} type={"Power usage"} />
				</div>
			</div>
		</div>
	</div>
