<div class="transparent-900 m-10 rounded-xl w-4/5 mx-auto">
	<div class="flex justify-start gap-5 mx-10 pt-10">
		<!-- cpu info -->
		<div class="rounded-xl p-10 transparent-800 mb-10 w-3/5 text-left">
		...
		<!-- cpu power usage -->
		<div class="transparent-800 rounded-xl p-10 mb-10 w-2/5 text-left">
			...
			<div>
				<!-- <LineChart statistics={$hardwareStatistics.cpu.power} type={"power"} /> -->
			</div>
		</div>
	</div>

	<div class="flex justify-start gap-5 mx-10">
		<!-- cpu temp -->
		<div class="transparent-800 rounded-xl p-10 mb-10 w-1/2 text-left">
			<div class="flex items-baseline gap-3 mb-5">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z" /></svg>
				<h2>CPU Temperature</h2>
			</div>
			<div>
				<LineChart statistics={$hardwareStatistics.cpu.temperature} />
			</div>
		</div>
	</div>
</div>
...
<script lang="ts">
	import LineChart from "../components/temperatureChart.svelte"
