<div class="flex flex-col items-center justify-center sm:m-2">
	<div class="my-20 text-center">
		<h2 class="mb-5 bg-gradient-to-r bg-clip-text text-center text-4xl font-extrabold text-white md:text-8xl">Getting Started</h2>
		<h3 class="italic text-gray-100">Start using Cores with just a few clicks.</h3>
	</div>
