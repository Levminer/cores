<Popover.Root>
	...
	<Popover.Content forceMount class="bg-background z-50 w-full max-w-[300px] overflow-hidden rounded-xl bg-gray-600 shadow-xl" sideOffset={8}>
					...
					<div {...props} transition:flyAndScale>
						...
						<div class="w-full p-3 px-5">
							...
							>
								...
								{/snippet}
								{#snippet confirmButton()}
									<Dialog.Close onclick={() => addConnectionCode()} class="smallButton">
										<Plus class="h-5 w-5" />
										Add
									</Dialog.Close>
								{/snippet}
